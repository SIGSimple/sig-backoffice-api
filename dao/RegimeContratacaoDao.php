...
class RegimeContratacaoDao{
	...
	public function getRegimesContratacao($busca=null){
		$sql = "SELECT * FROM tb_regime_contratacao";
		...
		if(is_array($busca) && count($busca) > 0) {
			...
			if($search != "") {
				$sql .= " WHERE dsc_regime_contratacao LIKE '%$search%'";
