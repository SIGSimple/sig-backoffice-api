...
<html>
	<head>
		...
		<style type="text/css">
			...
			/*!
			 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=d9cb8aee6d5eb31e3202)
			 * Config saved to config.json and https://gist.github.com/d9cb8aee6d5eb31e3202
			 */
			/*!
			 * Bootstrap v3.3.5 (http://getbootstrap.com)
			 * Copyright 2011-2015 Twitter, Inc.
				...
				<div class="panel-body">
					<form class="form form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-5 col-md-5 col-lg-5">
								<input class="form-control" disabled="disabled" value="<?=((isset($cooperator['funcao']['nme_funcao']) ? $cooperator['funcao']['nme_funcao'] : ''))?>">
							</div>
